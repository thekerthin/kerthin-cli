...
$ ${packageManagerRunner} build && ${packageManagerRunner} start-prod`;
  ...
  VALUE_OBJECT_GENERATING_FILES: 'Generating value object files.\n',
  VALUE_OBJECT_FILES_GENERATED: 'Value object files generated.',
  MODULES_NOT_FOUND: 'There are not modules defined yet.',
  ENTITY_GENERATING_FILES: 'Generating entity file.\n',
  ENTITY_FILES_GENERATED: 'Entity files generated.',
